 ...
 */
public class LGX extends NonRandomizedLGX {
	private static Parameter DEFAULT_BASE = GPBreedDefaults.base().push("LGX");
	...
	protected SimpleNodeBase<?> getAverageProgram(final int thread, final GPNode p1, final GPNode p2,
			final MersenneTwisterFast random, final int maxHeight) {
		GPNode newSubtree;
